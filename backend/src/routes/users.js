...
// router.delete('/messages/:id', usersController.deleteMessage)
router.delete('/:userId/messages/:messageId', usersController.deleteMessage)
router.delete('/:userId/messages', usersController.deleteMultipleMessages)
