...
import { GoogleIcon } from '@/src/companents/icons/icons'
...
export const AuthForm = ({isRegister})=>{
  ...
  //   // Отправьте credential на ваш сервер для верификации и получения данных пользователя
  //   console.log('Google login successful:', credential)
  //   // Здесь можно добавить логику для получения данных профиля пользователя
  // }
