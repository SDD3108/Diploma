...
const AgreementPageBuilder = () => {
  ...
  <h1 class="text-3xl font-bold mb-6">Пользовательское Соглашение для ticketFlow</h1>
  ...
  <div class="space-y-4">
    ...
    <div class="bg-gray-50 p-4 rounded-lg">
      <h2 class="text-xl font-semibold mb-2">2. Процесс бронирования</h2>
    ...
    <div class="bg-gray-50 p-4 rounded-lg">
      <h2 class="text-xl font-semibold mb-2">3. Финансовые условия</h2>
    ...
    <div class="bg-gray-50 p-4 rounded-lg">
      <h2 class="text-xl font-semibold mb-2">4. Ответственность</h2>
    ...
    <div class="bg-gray-50 p-4 rounded-lg">
      <h2 class="text-xl font-semibold mb-2">5. Технические требования</h2>
    ...
    <div class="bg-gray-50 p-4 rounded-lg">
      <h2 class="text-xl font-semibold mb-2">6. Конфиденциальность</h2>
